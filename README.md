...
naming the one-argument form since the D4 expiry (tap/DspTap#__PR__; API break,
...
cycle) and are removed since tap/DspTap#__PR__ (API break; neither consumer calls them:
