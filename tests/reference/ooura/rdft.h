...
// kept in this directory: rdft from fftsg.c (double) and rdft_f from
// fftsg_float.c (the same source instantiated for float). Until Stage 2c
// these declarations lived in include/tap/dsp/fft.h, where the shipping
// wrapper called them; since the flip (Stage 2b) nothing that ships reaches
// them, and Stage 2c moved the C out of the shipping tree
